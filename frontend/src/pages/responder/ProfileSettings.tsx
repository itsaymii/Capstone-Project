    ...
    <div className="min-h-screen bg-slate-50 pb-28 sm:pb-12 pt-6 antialiased text-slate-800">
      <main className="max-w-4xl mx-auto p-4 sm:p-6 space-y-6">
        ...
        <div className="flex items-center gap-4 bg-white p-4 rounded-2xl border border-slate-100 shadow-sm">
          ...
          <div>
            <h1 className="text-xl font-bold tracking-tight text-slate-900">Profile & Team Settings</h1>
            <p className="text-xs text-slate-500 mt-0.5 font-medium">Manage your commander credentials and control your active responder roster.</p>
          </div>
        </div>
      ...
      <nav className="sm:hidden fixed bottom-0 left-0 right-0 bg-white/95 backdrop-blur-md border-t border-slate-200 shadow-[0_-4px_16px_rgba(15,23,42,0.06)] z-50 px-2 py-2">
        <div className="flex justify-around items-center">
          ...
          <button 
            ...
            className={`flex flex-col items-center gap-1 py-1 px-3 transition-all active:scale-95 ${
              isActiveNav('/create-report') ? 'text-blue-600' : 'text-slate-400 hover:text-slate-600'
            }`}
          ...
          <button 
            ...
            className={`flex flex-col items-center gap-1 py-1 px-3 transition-all active:scale-95 ${
              isActiveNav('/responder-reports') ? 'text-blue-600' : 'text-slate-400 hover:text-slate-600'
            }`}
